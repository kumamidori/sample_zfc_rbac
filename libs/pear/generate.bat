...
GOTO doshift
:noshift
/usr/local/php5/bin/php -q -d output_buffering=1 -d include_path="/var/www/auth.local/libs/pear/php" /var/www/auth.local/libs/pear/Text/Highlighter/generate.bat %MHL_PARAMS%
